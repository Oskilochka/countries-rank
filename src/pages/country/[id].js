            ...
            <div className={styles.wrap}>
                ...
                <div>
                    ...
                    <div className={styles.detailsRow}>
                        ...
                        <div
                            className={styles.detailsValue}> {country.currencies.map(({name}) => name).join(', ')} </div>
                    </div>
                    <div className={styles.detailsRow}>
                ...
                <div className={styles.neighbours}>
                    ...
                    <div className={styles.bordersWrap}>
                        {borders.length > 0 ? borders.map(({flag, name}) =>
                            <div className={styles.border}>
                                <img className={styles.borderFlag} src={flag} alt={name}/>
